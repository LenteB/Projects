...
//NEW MOVIES =============================================================================================
const filterNieuw = movies.filter((movie) => {
  return movie.Year >= "2011"
})

const nieuweFilms = filterNieuw.map((movie) => {
  return movie.Poster
})

const nieuweNamen = filterNieuw.map((movie) => {
  return movie.Title
})


document.mainForm.nieuwste.onclick = function () {
  for (i = 0; i < nieuweFilms.length; i++) {
    var li = document.createElement("li");
    var foto1 = document.createElement('img');
    foto1.src = nieuweFilms[i];
    li.appendChild(foto1);
    document.getElementById("myUl").appendChild(foto1);
  }
}
...
const avMovies = movies.filter((movie) => {
  return movie.Title.includes("Avengers")
})

const avPosters = avMovies.map((movie) => {
  return movie.Poster
})

document.mainForm.avengers.onclick = function () {
  for (i = 0; i < avPosters.length; i++) {
    var li = document.createElement("li");
    var foto = document.createElement('img');
    foto.src = avPosters[i];
    li.appendChild(foto);
    document.getElementById("myUl2").appendChild(foto);
  }
}

//XMEN =============================================================================================

const xMovies = movies.filter((movie) => {
  return movie.Title.includes("X-Men")
})

const xPosters = xMovies.map((movie) => {
  return movie.Poster
})

document.mainForm.xmen.onclick = function () {
  for (i = 0; i < xPosters.length; i++) {
    var li = document.createElement("li");
    var foto2 = document.createElement('img');
    foto2.src = xPosters[i];
    li.appendChild(foto2);
    document.getElementById("myUl3").appendChild(foto2);
  }
}
...
const pMovies = movies.filter((movie) => {
  return movie.Title.includes("Princess")
})

const pPosters = pMovies.map((movie) => {
  return movie.Poster
})

document.mainForm.princess.onclick = function () {
  for (i = 0; i < pPosters.length; i++) {
    var li = document.createElement("li");
    var foto3 = document.createElement('img');
    foto3.src = pPosters[i];
    li.appendChild(foto3);
    document.getElementById("myUl4").appendChild(foto3);
  }
}

//PRINCESS =============================================================================================

const batMovies = movies.filter((movie) => {
  return movie.Title.includes("Batman")
})

const batPosters = batMovies.map((movie) => {
  return movie.Poster
})

document.mainForm.batman.onclick = function () {
  for (i = 0; i < batPosters.length; i++) {
    var li = document.createElement("li");
    var foto4 = document.createElement('img');
    foto4.src = batPosters[i];
    li.appendChild(foto4);
    document.getElementById("myUl5").appendChild(foto4);
  }
}

//ALL MOVIES =============================================================================================

const allePosters = movies.map((movie) => {
  return movie.Poster
})

const alleNamen = movies.map((movie) => {
  return movie.Title
})

document.mainForm.alle.onclick = function () {
  for (i = 0; i < allePosters.length; i++) {
    var li = document.createElement("li");
    var foto5 = document.createElement('img');
    foto5.src = allePosters[i];
    li.appendChild(foto5);
    document.getElementById("myUl6").appendChild(foto5);
  }
}

const alleimdbID = movies.map((movie) => {
  return movie.imdbID
})
...
document.getElementById('myUl').addEventListener("click", function () {
  for (i = 0; i < alleimbdID.length; i++) {
    document.getElementById("myUl").appendChild(foto5)
    window.location.href = "https://www.imdb.com/title/tt0944947/";
}  });
*/